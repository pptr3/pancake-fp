...
<body>
  <span id="drink" style="display:none;"></span>
  <div class="container">
    <div class="row">
    <br/>
    <br/>
       <nav class="navbar navbar-inverse">
        <div class="container-fluid">
         <div class="navbar-header">
          <a class="navbar-brand" href="#">Choose drink</a>
         </div>
    ...
    <br/>
<?php
$query_sql="SELECT * FROM Item WHERE CategoryID=2 AND Deleted=0";
...
<script type="text/javascript">
  function Selected(idItem) {
    ...
    document.getElementById('drink').innerHTML = idItem;
  }

  function SubmitDrink() {
    var drink = document.getElementById('drink').innerHTML;
    window.location = "SubmitDrinkInRP.php?dri="+drink;
  }
...
<div class="row2">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <a href="AddRoyalPancake.php" href="#" class = "btn btn-default btn-lg" role="button">Back</a>
  </div>
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <a onclick="SubmitDrink()" class = "btn btn-default btn-lg" role="button">Add</a>
  </div>
</div>
</body>
</html>
